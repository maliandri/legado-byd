        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <div className="relative overflow-hidden rounded-sm"
              ...
              {hasMultiple && (
                <>
                  <button onClick={() => setImgIndex(i => (i - 1 + imagenes.length) % imagenes.length)}
                  ...
                  <button onClick={() => setImgIndex(i => (i + 1) % imagenes.length)}
          ...
          <div className="flex flex-col">
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", color: '#3D1A05',
              fontSize: 'clamp(1.6rem, 4vw, 2.2rem)', fontWeight: 700, lineHeight: 1.2,
              marginTop: '8px', marginBottom: '12px' }}>
              {producto.nombre}
            </h1>
            <div className="mb-4">
              <span className="inline-block px-3 py-1 rounded-sm text-sm font-semibold"
            ...
            {producto.descripcion && (
              <p style={{ color: '#6B3A1A', fontSize: '1rem', lineHeight: '1.7', marginBottom: '24px', flexGrow: 1 }}>
                {producto.descripcion}
              </p>
            )}
            ...
            <div className="mb-6">
              ...
              <div style={{ fontFamily: "'Playfair Display', serif", color: '#3D1A05',
                fontSize: '2rem', fontWeight: 800, lineHeight: 1, marginTop: '4px' }}>
                ${producto.precio.toLocaleString('es-AR')}
              </div>
            </div>
            <div className="flex flex-col gap-3">
              <a href={`https://wa.me/${whatsapp}?text=${mensaje}`} target="_blank" rel="noopener noreferrer"
              ...
              <button onClick={handleAgregar} disabled={!producto.stock}
