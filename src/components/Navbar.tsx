    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-5">
            ...
            <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-2 rounded-sm text-sm font-semibold hover:opacity-90 transition-opacity"
      ...
      {open && (
        <div style={{ backgroundColor: '#EDD9A3', borderTop: '1px solid #C4A040' }}
          ...
          <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-3 rounded-sm text-sm font-semibold justify-center mt-2"
            style={{ backgroundColor: '#C4A040', color: '#3D1A05' }}>
